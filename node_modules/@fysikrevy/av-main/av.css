...
.slides > article {
  ...
  transform: scale(2.5) translate( -90px, -45px );
...
.slides > .vidframe {
    ...
    margin-left: -500px;
    margin-top: -340px;
    transform: scale(.85) translate( -270px, -115px );
    /* color: red; */
}
...
/* # MIMICKING -------------------------------------------------------------- */
/* The whole mimick mechanism is still very much WIP (as of v1.0.0) 
*/

/* body.left .slides article > :not(.mimicking), */
/* body.mid .slides article > :not(.mimicking), */
/* body.right .slides article > :not(.mimicking) { */
/*     display: none; */
/* } */
...
/* article.mimicking > :not(.mimicking) { */
/*     display: none; */
/* } */
